        ...
        <div class="flex gap-6">
          ...
          <div class="mt-2">
            ...
            <p class="md:label-small mt-1">
              ...
              <b class="body-small text-surface-950 dark:text-surface-0">$2500</b> has been
              initiated.
            </p>
          </div>
        </div>
        <div class="flex gap-6">
          ...
          <div class="mt-2">
            ...
            <p class="md:label-small mt-1">
              ...
              <b class="body-small text-surface-950 dark:text-surface-0">new question</b> about your
              product.
            </p>
          </div>
        </div>
