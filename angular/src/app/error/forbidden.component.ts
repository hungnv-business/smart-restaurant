        ...
        <div class="bg-white dark:bg-surface-800 rounded-3xl shadow-2xl overflow-hidden">
          ...
          <div class="p-8 text-center">
            ...
            <div class="mb-8">
              ...
              @if (currentUserRole) {
                <div class="bg-surface-100 dark:bg-surface-700 rounded-xl p-6 mb-6 text-left">
                  <div class="flex justify-between items-center">
                    <strong class="text-surface-600 dark:text-surface-400"
                      >Vai trò hiện tại:</strong
                    >
                    <span class="text-blue-600 dark:text-blue-400 font-medium">{{
                      getVietnameseRoleName(currentUserRole)
                    }}</span>
                  </div>
                </div>
              }
              ...
              <div
                class="flex items-center justify-center gap-2 bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg p-4 text-yellow-800 dark:text-yellow-200"
              >
          ...
          <div class="border-t border-surface-200 dark:border-surface-700 text-center p-4">
            <small
              class="text-surface-500 dark:text-surface-400 flex items-center justify-center gap-2"
            >
