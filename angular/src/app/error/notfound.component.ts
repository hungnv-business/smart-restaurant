  ...
  >
    <div class="landing-container mx-auto relative z-10 px-12">
      <div class="relative mt-24 max-w-[46rem] mx-auto">
        ...
        >
          <h2
            class="text-4xl lg:text-6xl font-semibold text-surface-950 dark:text-surface-0 mt-8 text-center"
          >
          ...
          <a
            routerLink="/"
            class="mt-8 inline-flex items-center justify-center px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition-colors duration-200"
          >
