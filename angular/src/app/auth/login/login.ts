      ...
      <div class="w-full max-w-[46rem] mx-auto px-6 lg:px-12">
        <div class="relative">
          ...
          >
            <div class="pt-8 pb-8">
              <h1
                class="text-4xl lg:text-6xl font-semibold text-surface-950 dark:text-surface-0 text-center"
              >
                Đăng nhập
              </h1>
            </div>
            <div class="flex flex-col gap-2">
              ...
              />
              <app-validation-error [control]="emailControl" fieldName="Email hoặc tên đăng nhập">
            ...
            <div class="flex flex-col gap-2">
              ...
              <app-validation-error [control]="passwordControl" fieldName="Mật khẩu">
              </app-validation-error>
            </div>
            <div class="flex items-center justify-between">
              <div class="flex items-center gap-2">
                <p-checkbox formControlName="remember" id="remember" binary />
                <label for="remember" class="text-surface-500 dark:text-white/64"
                  >Nhớ đăng nhập</label
                >
              </div>
