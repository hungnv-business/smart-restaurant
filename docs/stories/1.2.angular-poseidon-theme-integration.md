...
- [x] **Step 5.1: Clean Up Unused Files** (Maintenance)
  - [x] Remove unused directories: pages/, public/, environments/, shared/
...
├── features/                  # Feature modules for restaurant operations
│   ├── dashboard/             # Restaurant dashboard with Poseidon components
│   ├── orders/                # Order processing with PrimeNG integration
│   ├── menu/                  # Menu CRUD with Vietnamese text support
│   ├── tables/                # Table layout with touch-friendly design
│   ├── payments/              # Payment processing
│   ├── kitchen/               # Kitchen displays
│   └── reservations/          # Reservation management
├── layout/                    # App layout (Poseidon layout system)
│   ├── components/            # Layout components (topbar, sidebar, footer)
│   └── service/               # LayoutService with restaurant customizations
...
- Setup layout wrapper for main restaurant feature modules in `angular/src/app/features/`
...
- Feature modules in `angular/src/app/features/` must use ABP service proxies for backend communication
